...
class DependencyGraph {
    ...
    constructor(private factories: RegisteredFactory[], private injections: BaseInjectedService[], private injectedParameters: BaseInjectedParameter[], private allInjections: BaseInjectAllService[], private parameterBag: ParameterBag) { }
