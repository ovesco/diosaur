...
export const refreshContainer = () => __awaiter(void 0, void 0, void 0, function* () {
...
export const register = (identifier, factory, config = {}) => {
    ...
    Registrer.registerFactory(fnFactory, Symbol(identifier.toString()), Object.assign(Object.assign({}, defaultConfig(identifier)), config));
};
export const registerAsync = (identifier, factory, config = {}) => {
    const maker = typeof factory === 'function' ? factory : () => factory;
    const finalConfig = Object.assign(Object.assign({}, defaultConfig(identifier)), config);
    const fnFactory = new FunctionFactory(maker);
